...
document.getElementById("popup").innerHTML += "<img class='rosa' src='//maps.googleapis.com/maps/api/streetview?size=500x500&location="+ll+"&fov="+fov+"&heading="+heading+"&pitch="+pitch+"&pano="+pano+"'/><br>";
